...
class TestRandomWalkNoiseStrategy(unittest.TestCase):
    ...
    def test_generate_noise(self):
        ...
        result = self.random_walk.generate_noise(price, fluctuation_rate)
    ...
    def test_fluctuation_rate_impact(self):
        ...
        low_fluctuation_result = self.random_walk.generate_noise(price, low_fluctuation_rate)
        high_fluctuation_result = self.random_walk.generate_noise(price, high_fluctuation_rate)
