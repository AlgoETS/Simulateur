    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="scenarios", to="simulation.company"
                    ),
                ),
                (
                    "events",
                    models.ManyToManyField(
                        related_name="scenarios", to="simulation.event"
                    ),
                ),
                (
                    "simulation_settings",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="scenarios", to="simulation.stock"
            ),
        ),
        migrations.AddField(
            model_name="scenario",
            name="teams",
            field=models.ManyToManyField(
                related_name="scenarios", to="simulation.team"
            ),
        ),
        migrations.CreateModel(
            name="Portfolio",
        ...
        migrations.AddField(
            ...
            name="triggers",
            field=models.ManyToManyField(
                related_name="scenarios", to="simulation.trigger"
            ),
        ),
        migrations.CreateModel(
            name="UserProfile",
        ...
        migrations.AddField(
            ...
            name="users",
            field=models.ManyToManyField(
                related_name="scenarios", to="simulation.userprofile"
            ),
        ),
        migrations.AddField(
